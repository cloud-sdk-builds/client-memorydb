...
[`@aws-sdk/client-memorydb`](https://www.npmjs.com/package/@aws-sdk/client-memorydb/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i/+Y1LFgCek+BRhoEc/lFN76++uQNSUZH5hAdNRNNs0DNPUcittOf8pq/L5Fnf33
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-memorydb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.549.0/index.min.mjs": "sha384-i/+Y1LFgCek+BRhoEc/lFN76++uQNSUZH5hAdNRNNs0DNPUcittOf8pq/L5Fnf33"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-memorydb/blob/refs/tags/3.549.0/LICENSE
```
