...
[`@aws-sdk/client-memorydb`](https://www.npmjs.com/package/@aws-sdk/client-memorydb/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BI8fhlBioJKNT1SEQsPECZWqWfdrOWxC1Ct8SZVVRGYRCdEYvSvOBCSSvvpzICDM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-memorydb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-memorydb@3.52.0/index.min.mjs": "sha384-BI8fhlBioJKNT1SEQsPECZWqWfdrOWxC1Ct8SZVVRGYRCdEYvSvOBCSSvvpzICDM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-memorydb/blob/refs/tags/3.52.0/LICENSE
```
